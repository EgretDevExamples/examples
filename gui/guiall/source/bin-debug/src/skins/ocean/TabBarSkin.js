    ...
    (function (ocean) {
        var TabBarSkin = (function (_super) {
            ...
            __egretProto__.dataGroup_i = function () {
                ...
                this.dataGroup = t;
                this.__s(t, ["percentHeight", "itemRenderer", "itemRendererSkinName", "percentWidth"], [100, new egret.gui.ClassFactory(egret.gui.TabBarButton), skins.ocean.TabBarButtonSkin, 100]);
                t.layout = this.__3_i();
                return t;
            };
